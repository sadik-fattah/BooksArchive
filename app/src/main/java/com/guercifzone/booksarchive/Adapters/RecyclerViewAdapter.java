...
import com.guercifzone.booksarchive.BooksDaiteils;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder> {
    ...
    private List<RecyclFeed> feedList;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull @NotNull ViewGroup viewGroup, int i) {
        ...
        view = inflater.inflate(R.layout.recyclerview_listitem,viewGroup,false);
        final MyViewHolder viewHolder = new MyViewHolder(view);
        viewHolder.view_content.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mcontext, BooksDaiteils.class);
    ...
    public void setFilteredList(List<RecyclFeed> filteredList) {
