...
public class Ar_CookingBooks extends AppCompatActivity {

    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/ArabicBooks/ArCookingBooks.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.rv_arCookingBook);
        searchView = (SearchView)findViewById(R.id.sv_Book_arCooking);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Ar_CookingBooks.this);
