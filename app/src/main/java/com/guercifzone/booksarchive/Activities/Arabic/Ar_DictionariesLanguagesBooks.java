...
public class Ar_DictionariesLanguagesBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/ArabicBooks/ArDictionaries.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ar_dictionaries_languages_books);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Ar_DictionariesLanguagesBooks.this);
