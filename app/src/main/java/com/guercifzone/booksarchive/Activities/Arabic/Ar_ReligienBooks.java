...
public class Ar_ReligienBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/ArabicBooks/ArReligien.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ar_religien_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_arreligien);
        searchView = (SearchView)findViewById(R.id.sv_Book_arReligien);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Ar_ReligienBooks.this);
