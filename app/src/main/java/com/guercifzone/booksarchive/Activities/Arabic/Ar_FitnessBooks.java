...
public class Ar_FitnessBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/ArabicBooks/ArFitness.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ar_fitness_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_arFitness);
        searchView = (SearchView)findViewById(R.id.sv_Book_arFitness);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Ar_FitnessBooks.this);
