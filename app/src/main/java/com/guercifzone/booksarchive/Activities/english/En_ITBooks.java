...
public class En_ITBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/EnglishBooks/En_IT.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.en_itbooks);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_enit);
        searchView = (SearchView)findViewById(R.id.sv_Book_enit);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(En_ITBooks.this);
