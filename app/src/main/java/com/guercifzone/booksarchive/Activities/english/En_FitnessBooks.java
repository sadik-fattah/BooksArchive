...
public class En_FitnessBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/EnglishBooks/EnFitness.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.en_fitness_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_enFitness);
        searchView = (SearchView)findViewById(R.id.sv_Book_enFitness);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(En_FitnessBooks.this);
