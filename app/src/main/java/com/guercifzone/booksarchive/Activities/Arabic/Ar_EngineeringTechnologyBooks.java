package com.guercifzone.booksarchive.Activities.Arabic;
...
public class Ar_EngineeringTechnologyBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/ArabicBooks/ArEngineering.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ar_engineering_technology_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_arEngineering);
        searchView = (SearchView)findViewById(R.id.sv_Book_arEngineering);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Ar_EngineeringTechnologyBooks.this);
