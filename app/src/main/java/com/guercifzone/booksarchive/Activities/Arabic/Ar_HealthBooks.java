...
public class Ar_HealthBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/ArabicBooks/ArHealth.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ar_health_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_arhealth);
        searchView = (SearchView)findViewById(R.id.sv_Book_arHealth);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(Ar_HealthBooks.this);
