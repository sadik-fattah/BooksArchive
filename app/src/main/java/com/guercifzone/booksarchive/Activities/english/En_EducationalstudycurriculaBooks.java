...
public class En_EducationalstudycurriculaBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/EnglishBooks/EnEducation.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.en_educationalstudycurricula_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_enEducation);
        searchView = (SearchView)findViewById(R.id.sv_Book_enEducation);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(En_EducationalstudycurriculaBooks.this);
