...
public class En_HumandeveBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/EnglishBooks/EnNovels.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.en_humandeve_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_enHumanDeve);
        searchView = (SearchView)findViewById(R.id.sv_Book_enHumanDeve);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(En_HumandeveBooks.this);
