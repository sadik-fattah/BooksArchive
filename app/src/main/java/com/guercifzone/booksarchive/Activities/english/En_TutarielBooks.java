...
public class En_TutarielBooks extends AppCompatActivity {
    private final String JSON_URL ="https://raw.githubusercontent.com/sadik-fattah/SimpleDataBase/main/BookCenter/EnglishBooks/EnTutariel.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.en_tutariel_books);
        lsArzone = new ArrayList<>();
        recyclerView = (RecyclerView) findViewById(R.id.rv_enscience);
        searchView = (SearchView)findViewById(R.id.sv_Book_enscience);
    ...
    private void Jsonrequest() {
        ...
        requestQueue = Volley.newRequestQueue(En_TutarielBooks.this);
